...
export default function LNGDashboardClient({ initialData }: LNGDashboardClientProps) {
  ...
  const traces = useMemo<Data[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        line: { color: "rgba(239, 68, 68, 0.95)" },
        fill: "tozeroy",
        opacity: 0.25,
  ...
  const layout = useMemo<Partial<Layout>>(() => {
    return {
      height: 980,
      margin: { l: 55, r: 55, t: 40, b: 80 },
      legend: { orientation: "h", x: 0, y: -0.18, font: { size: 10 } },
      hovermode: "x unified",
      grid: { rows: 3, columns: 1, pattern: "independent", roworder: "top to bottom", ygap: 0.08 },
      xaxis: { title: { text: "Week" }, showgrid: false, tickformat: "%b %y", automargin: true },
      xaxis2: { matches: "x", showgrid: false, tickformat: "%b %y", automargin: true },
      xaxis3: {
        matches: "x",
        showgrid: false,
        tickformat: "%b %y",
      ...
      yaxis: { title: { text: "Cargoes" }, range: [0, 50], automargin: true },
      yaxis2: {
      ...
      yaxis3: { title: { text: "VG Cargoes" }, range: [0, 15], automargin: true },
      yaxis4: { title: { text: "Cargoes" }, range: [0, 50], automargin: true },
      yaxis5: {
      ...
      annotations: [
        {
          text: "US total vs VG deliveries + TTF-HH spread",
          xref: "paper",
          yref: "paper",
          x: 0,
          y: 1.05,
        ...
        {
          text: "VG terminal cargo cadence",
          xref: "paper",
          yref: "paper",
          x: 0,
          y: 0.61,
        ...
        {
          text: "US total vs JKM-HH spread",
          xref: "paper",
          yref: "paper",
          x: 0,
          y: 0.2,
